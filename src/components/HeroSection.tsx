export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden mt-8 md:mt-12">
      ...
      <div className="relative flex flex-col items-center justify-start px-6 md:px-12 gap-8">
        {/* Subheading */}
        ...
        <div className="w-full flex flex-col items-center ">
          <h1 className="font-grotesk text-4xl xxs:text-5xl xs:text-6xl sm:text-7xl md:text-8xl font-black text-black tracking-tight text-center leading-[1.1] md:leading-[1.2] animate-hero-fade-in space-y-1 uppercase">
